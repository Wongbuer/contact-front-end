<template>
  <div id="app">
    ...
    <el-button @click="dialogFormVisible1 = true">点击</el-button>
...
export default {
  ...
  methods: {
    add () {
      ...
      axios.post('http://localhost:8081/contact', JSON.stringify(this.newdata), {
        headers: {
...
header {
  ...
  h1 {
    ...
    font: italic 900/100px 32px "Microsoft YaHei UI";
  }
}
</style>
